    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              Khám phá vẻ đẹp vượt thời gian với bộ sưu tập đồng hồ cao cấp của chúng tôi. 
              Được chế tác hoàn hảo, thiết kế dành riêng cho bạn.
            </p>
          ...
          <div className="footer-links">
            ...
            <div className="footer-section">
              ...
              <ul>
                ...
                <li><a href="#shipping">Thông Tin Vận Chuyển</a></li>
            ...
            <div className="footer-section">
              ...
              <ul>
                ...
                <li><a href="#cookies">Cài Đặt Cookie</a></li>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Chrono Watches. Bảo lưu mọi quyền.</p>
